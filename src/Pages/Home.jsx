...
const Home = () => {
  ...
  return (
    <div id="home" className={`min-h-screen md:h-screen flex flex-col md:flex-row items-center justify-between px-6 md:px-10 py-16 
      ${theme === "dark" ? "bg-[#0c1426]" : "bg-gray-50"} transition-colors duration-500`}
  >
      {/* Text Section */}
      <div className="md:w-1/3  text-center md:text-left space-y-6">
        ...
        >
          Discover your inner peace and take control of your mental health with
          our personalized assessments.
        </p>
        <p
          className={`text-md ${
            theme === "dark" ? "text-gray-400" : "text-gray-800"
        ...
        >
          ...
          help you understand your emotional well-being and provide insights for
          improvement.
        </p>
        <p
          className={`text-md ${
        ...
        >
          Take a quick self-assessement Test to gain valuable insights into your
          mental health and well-being. Our user-friendly platform makes it easy
          to track your progress and access resources tailored to your needs.
        </p>
...
>
  Start General Test
          ...
          >
            ...
            {isHovered && (
              <div className={`absolute bottom-1 ml-24 w-60 border rounded-md shadow-md z-10 ${
                theme === "dark" ? "bg-[#1b2432] text-gray-200 border-gray-600" : "bg-white text-gray-800"
              }`}>
          ...
          {selectedCategory && (
            <p className={`text-sm ml-2 ${theme === "dark" ? "text-gray-300" : "text-gray-500"}`}>
